...
<body>
    ...
    <div class="main">
        ...
        <div class="p-3 m-3 bg-white rounded">
            ...
            <p>
                وبسایت مجله اینترنتی بهنام با هدف تولید محتوای یکتای چند رسانه ای در وب فارسی در سال ۱۳۹۶ ایجاد شده
            </p>

            <p>
                ما ۴ وبلاگ نویس علاقه مند به موضوعات مختلف هستیم و سعی ما بر این است که همواره مطالب جالب و مفید وارد وب فارسی کنیم
            </p>
        </div>
